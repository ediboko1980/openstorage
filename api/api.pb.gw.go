...
var (
	filter_OpenStorageNodeDrain_DrainAttachments_0 = &utilities.DoubleArray{Encoding: map[string]int{"node_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_OpenStorageNodeDrain_DrainAttachments_0(ctx context.Context, marshaler runtime.Marshaler, client OpenStorageNodeDrainClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_OpenStorageNodeDrain_DrainAttachments_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_OpenStorageNodeDrain_UpdateNodeDrainJobState_0 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_OpenStorageNodeDrain_UpdateNodeDrainJobState_0(ctx context.Context, marshaler runtime.Marshaler, client OpenStorageNodeDrainClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_OpenStorageNodeDrain_UpdateNodeDrainJobState_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func request_OpenStorageNodeDrain_GetDrainStatus_0(ctx context.Context, marshaler runtime.Marshaler, client OpenStorageNodeDrainClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func request_OpenStorageNodeDrain_EnumerateNodeDrainJobs_0(ctx context.Context, marshaler runtime.Marshaler, client OpenStorageNodeDrainClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
// RegisterOpenStorageNodeDrainHandlerFromEndpoint is same as RegisterOpenStorageNodeDrainHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterOpenStorageNodeDrainHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	conn, err := grpc.Dial(endpoint, opts...)
	if err != nil {
		return err
	}
	...
	return RegisterOpenStorageNodeDrainHandler(ctx, mux, conn)
}

// RegisterOpenStorageNodeDrainHandler registers the http handlers for service OpenStorageNodeDrain to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterOpenStorageNodeDrainHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterOpenStorageNodeDrainHandlerClient(ctx, mux, NewOpenStorageNodeDrainClient(conn))
}

// RegisterOpenStorageNodeDrainHandler registers the http handlers for service OpenStorageNodeDrain to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "OpenStorageNodeDrainClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "OpenStorageNodeDrainClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "OpenStorageNodeDrainClient" to call the correct interceptors.
func RegisterOpenStorageNodeDrainHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OpenStorageNodeDrainClient) error {

	mux.Handle("PUT", pattern_OpenStorageNodeDrain_DrainAttachments_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_OpenStorageNodeDrain_DrainAttachments_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_OpenStorageNodeDrain_DrainAttachments_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("PUT", pattern_OpenStorageNodeDrain_UpdateNodeDrainJobState_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_OpenStorageNodeDrain_UpdateNodeDrainJobState_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_OpenStorageNodeDrain_UpdateNodeDrainJobState_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_OpenStorageNodeDrain_GetDrainStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_OpenStorageNodeDrain_GetDrainStatus_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_OpenStorageNodeDrain_GetDrainStatus_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_OpenStorageNodeDrain_EnumerateNodeDrainJobs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_OpenStorageNodeDrain_EnumerateNodeDrainJobs_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_OpenStorageNodeDrain_EnumerateNodeDrainJobs_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_OpenStorageNodeDrain_DrainAttachments_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"v1", "nodes", "drain", "attachments", "node_id"}, ""))

	pattern_OpenStorageNodeDrain_UpdateNodeDrainJobState_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"v1", "nodes", "drain", "job", "id"}, ""))

	pattern_OpenStorageNodeDrain_GetDrainStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"v1", "nodes", "drain", "job", "id"}, ""))

	pattern_OpenStorageNodeDrain_EnumerateNodeDrainJobs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "nodes", "drain", "job"}, ""))
)

var (
	forward_OpenStorageNodeDrain_DrainAttachments_0 = runtime.ForwardResponseMessage

	forward_OpenStorageNodeDrain_UpdateNodeDrainJobState_0 = runtime.ForwardResponseMessage

	forward_OpenStorageNodeDrain_GetDrainStatus_0 = runtime.ForwardResponseMessage

	forward_OpenStorageNodeDrain_EnumerateNodeDrainJobs_0 = runtime.ForwardResponseMessage
)
